...
ActiveRecord::Schema[7.0].define(version: 2023_10_18_113082) do
  ...
  create_table "alchemy_essence_spree_products", id: :serial, force: :cascade do |t|
    t.integer "spree_product_id"
    t.index ["spree_product_id"], name: "index_alchemy_essence_spree_products_on_spree_product_id"
  end

  create_table "alchemy_essence_spree_taxons", id: :serial, force: :cascade do |t|
    t.integer "taxon_id"
  ...
  create_table "alchemy_essence_spree_variants", force: :cascade do |t|
    t.bigint "variant_id"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["variant_id"], name: "index_alchemy_essence_spree_variants_on_variant_id"
  end
  ...
  add_foreign_key "alchemy_essence_spree_variants", "spree_variants", column: "variant_id"
